...
Widget favCard(User item, FavouriteController favouriteController){
  return Container(
        ...
        Row(
          ...
          children: [
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          item.share.shareSource.toString()),
                    ],
                  ),
                ),
              ],
            ...
            GestureDetector(
                ...
                child: Obx(() => favouriteController.favourites.value.favourites_items.contains(item) ? const Icon(Icons.favorite, color: Colors.red) : const Icon(
